...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/fenicsx-pulse-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/fenicsx-pulse-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add fenicsx-pulse
# for installing globally
pixi global install fenicsx-pulse
```
...
It is possible to list all of the versions of `fenicsx-pulse` available on your platform:
...
```
pixi search fenicsx-pulse --channel conda-forge
```
